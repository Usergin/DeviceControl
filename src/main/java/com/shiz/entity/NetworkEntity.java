 ...
 */
@Entity
@Table(name = "Network", schema = "mydb")
...
public class NetworkEntity {
    ...
    private DeviceEntity networkDeviceEntity;
    ...
    public DeviceEntity getNetworkByDeviceId() {
        return networkDeviceEntity;
    }

    public void setNetworkByDeviceId(DeviceEntity networkDeviceEntity) {
